...
# 오디오 파일을 불러옵니다.
sound_file = AudioSegment.from_wav("samgpt.wav")
...
for chunk in chunks:
    ...
    elif len(chunk) > 20000:  # 20초가 넘으면
        while len(chunk) > 20000:
            part, chunk = chunk[:20000], chunk[20000:]
